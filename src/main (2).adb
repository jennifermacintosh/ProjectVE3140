...
begin
    Ultrasonic.Setup(10,4); -- trigger is MB pin 14, echo is MB pin 15
    --Ultrasonic.Setup(10,19);                        -- implementation quirk: due to sensitive timing (microseconds), the implementation is really low level. Even an if statement takes too long.
